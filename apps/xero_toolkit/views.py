...
b64_id_secret = base64.b64encode(bytes(xeromanager.constants.XERO_CLIENT_ID + ':' + xeromanager.constants.XERO_CLIENT_SECRET, 'utf-8')).decode('utf-8')
...
def XeroFirstLogin(request):
    ...
    auth_url = ('''https://login.xero.com/identity/connect/authorize?''' +
                '''response_type=code''' +
                '''&client_id=''' + xeromanager.constants.XERO_CLIENT_ID +
